<?php
session_start();
if(!isset($_SESSION['login']) || ($_SESSION['login'] == "false") || ($_SESSION['credential'] != "academy")){
...
<head>
    ...
    <title id="title">Academic Office</title>
...
<div class="container">
    ...
    <div class="menu">
        ...
        <button class="menu-items" onclick="loadDepartments()">
            Register Department
        </button>
...
<div id="left" class="fixed-header">
    <div class="logo-container">
        <a href="../RSAS.net/homepage.php"><img src="../RSAS.net/images/logo4.png" alt="website" class="site-logo"></a>
